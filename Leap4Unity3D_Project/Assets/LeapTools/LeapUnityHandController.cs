...
{	
	...
	void Start()
	{
		...
		Leap4Unity.PointableFound += new Leap4Unity.PointableFoundHandler(OnPointableFound);
		Leap4Unity.PointableLost += new Leap4Unity.ObjectLostHandler(OnPointableLost);
        Leap4Unity.PointableUpdated += new Leap4Unity.PointableUpdatedHandler(OnPointableUpdated);

        //Gesture
        Leap4Unity.PointableCircleGesture += new Leap4Unity.PointGestureHandler(OnPointableCircleGestureUpdated);
        Leap4Unity.PointableSwapGesture += new Leap4Unity.PointGestureHandler(OnPointableSwapGestureUpdated);
        Leap4Unity.PointableKeyTapGesture += new Leap4Unity.PointGestureHandler(OnPointableKeyTapGestureUpdated);
        Leap4Unity.PointableScreenTapGesture += new Leap4Unity.PointGestureHandler(OnPointableScreenTapGestureUpdated);
    ...
    void OnPointableCircleGestureUpdated(Leap.Gesture g)
    {
        Leap.CircleGesture cg = new CircleGesture(g);
        Debug.Log("GestureGot!_ Circle:   "+cg.Center.ToString());
    }

    void OnPointableSwapGestureUpdated(Leap.Gesture g)
    {
        Leap.SwipeGesture sg = new SwipeGesture(g);
        Debug.Log("GestureGot!_Swap:    " + sg.Direction);
    }


    void OnPointableKeyTapGestureUpdated(Leap.Gesture g)
    {
        Leap.KeyTapGesture ktg = new KeyTapGesture(g);
        Debug.Log("GestureGot!_KeyTap:    " +ktg.Direction);
    }

    void OnPointableScreenTapGestureUpdated(Leap.Gesture g)
    {
        Leap.ScreenTapGesture stg = new ScreenTapGesture(g);
        Debug.Log("GestureGot!_ScreenTap:    " +stg.Position);
    }
