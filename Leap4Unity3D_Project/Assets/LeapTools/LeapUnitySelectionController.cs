...
public class LeapUnitySelectionController : MonoBehaviour {
	...
	{
		return Leap4Unity.EnableTranslation && m_Touching.Count >= 1;	
	}
	public virtual bool CheckShouldRotate(Frame thisFrame)
	{
		return Leap4Unity.EnableRotation && m_Touching.Count >= 2;
	}
	public virtual bool CheckShouldScale(Frame thisFrame)
	{
		return Leap4Unity.EnableScaling && m_Touching.Count >= 2;
	}
	...
	void Update()
	{
		Leap.Frame thisFrame = Leap4Unity.Frame;
		if( thisFrame == null ) 
			return;
